...
export default function StoryDashboardPage() {
  ...
  const handleNewChapter = useCallback(() => {
    ...
    router.push(`/library/${libraryId}/stories/${storyId}/chapters/${chapterId}`);
  ...
  if (!story) {
    return (
      <div className="library-page-empty">
        <p>Story not found.</p>
        <button className="library-page-action" onClick={() => router.push(`/library/${libraryId}/stories`)}>
          ← Back to Stories
        </button>
      </div>
    );
      ...
      <div className="library-dashboard-header">
        ...
        <div className="library-dashboard-quick-actions">
          ...
          <button
            ...
            onClick={() => router.push(`/library/${libraryId}/stories/${storyId}/beats`)}
          >
            Beats &amp; Outline
          </button>
        </div>
      ...
      <div className="library-dashboard-cards">
        ...
        <div className="library-dashboard-card" style={{ gridColumn: "1 / -1" }}>
          <div className="library-dashboard-card-header">
            ...
            <button onClick={() => router.push(`/library/${libraryId}/stories/${storyId}/chapters`)}>
              View all →
            </button>
          </div>
          {storyChapters.length === 0 ? (
            ...
            <ul className="library-dashboard-list">
              {storyChapters.slice(0, 8).map((ch) => (
                <li key={ch.id}>
                  <button
                    onClick={() => router.push(`/library/${libraryId}/stories/${storyId}/chapters/${ch.id}`)}
                  >
        ...
        <div className="library-dashboard-card placeholder-card">
          <div className="library-dashboard-card-header">
            <h3>Beats &amp; Outline</h3>
            <button onClick={() => router.push(`/library/${libraryId}/stories/${storyId}/beats`)}>
              View →
            </button>
          </div>
