...
export default function StoryChaptersPage() {
  ...
  const handleNewChapter = () => {
    ...
    router.push(`/library/${libraryId}/stories/${storyId}/chapters/${id}`);
  };
      ...
      <div className="library-page-header">
        <div>
          <button
            ...
            onClick={() => router.push(`/library/${libraryId}/stories/${storyId}`)}
          >
            ← {story?.title ?? "Story"}
          </button>
          <h2>Chapters</h2>
          ...
          {chapters.map((ch, i) => (
            <li key={ch.id} className="library-item-row">
              <button
                ...
                onClick={() =>
                  router.push(`/library/${libraryId}/stories/${storyId}/chapters/${ch.id}`)
                }
              >
